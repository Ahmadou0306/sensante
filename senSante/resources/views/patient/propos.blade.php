    ...
    <div class="row text-center">
        ...
        <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4">
                <img src="{{ url('images/equipes/moi.jpeg') }}" alt="Ahmadou Ndiaye" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                <h5 class="mb-0">Ahmadou NDIAYE</h5>
        ...
        <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4">
                <img src="{{url('images/equipes/toure.png')}}" alt="Mouhammad TOURE" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                <h5 class="mb-0">Mouhammad TOURE</h5>
        ...
        <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4">
                <img src="{{url('images/equipes/dabo.png')}}" alt="Mame Coumba DABO" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                <h5 class="mb-0">Mame Coumba DABO</h5>
        ...
        <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4">
                <img src="{{url('images/equipes/amara.png')}}" alt="Amara DIALLO" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                <h5 class="mb-0">Amara DIALLO</h5>
                <span class="small text-uppercase text-muted">Ingénieur DevOps</span>
                <ul class="social mb-0 list-inline mt-3">
                    <li class="list-inline-item"><a href="#" class="social-link"><i class="bx bxl-twitter"></i></a></li>
                    <li class="list-inline-item"><a href="#" class="social-link"><i class="bx bxl-linkedin"></i></a></li>
                    <li class="list-inline-item"><a href="#" class="social-link"><i class="bx bxl-facebook"></i></a></li>
        ...
        <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4">
                <img src="{{url('images/equipes/issa.png')}}" alt="Alhassane Issa TRAORE" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                <h5 class="mb-0">Alhassane Issa TRAORE</h5>
                <span class="small text-uppercase text-muted">Architecte cloud </span>
                <ul class="social mb-0 list-inline mt-3">
                    <li class="list-inline-item"><a href="#" class="social-link"><i class="bx bxl-twitter"></i></a></li>
                    <li class="list-inline-item"><a href="#" class="social-link"><i class="bx bxl-linkedin"></i></a></li>
                    <li class="list-inline-item"><a href="#" class="social-link"><i class="bx bxl-facebook"></i></a></li>
        ...
        <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4">
                <img src="{{url('images/equipes/saly.png')}}" alt="Ababacar SALY" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                <h5 class="mb-0">Ababacar SALY</h5>
                <span class="small text-uppercase text-muted">Security Engineer</span>
                <ul class="social mb-0 list-inline mt-3">
                    <li class="list-inline-item"><a href="#" class="social-link"><i class="bx bxl-twitter"></i></a></li>
                    <li class="list-inline-item"><a href="#" class="social-link"><i class="bx bxl-linkedin"></i></a></li>
                    <li class="list-inline-item"><a href="#" class="social-link"><i class="bx bxl-facebook"></i></a></li>
